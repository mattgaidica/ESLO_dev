...
linker.cmd: package/cfg/simple_central_app_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/simple_central_app_pem4fcfg.cmd\)\"$""\"/Users/matt/ti/workspaces/ESLO_dev/simple_central_CC26X2R1_BASE_STATIONS/.config/xconfig_simple_central_app/\1\""' package/cfg/simple_central_app_pem4f.xdl > $@
