...
linker.cmd: package/cfg/release_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/release_pem4fcfg.cmd\)\"$""\"/Users/matt/ti/workspaces/ESLO_dev/tirtos_builds_CC2652RB_LAUNCHXL_release_ccs/.config/xconfig_release/\1\""' package/cfg/release_pem4f.xdl > $@
