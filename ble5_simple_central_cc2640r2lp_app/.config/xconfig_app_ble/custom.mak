...
linker.cmd: package/cfg/app_ble_pem3.xdl
	$(SED) 's"^\"\(package/cfg/app_ble_pem3cfg.cmd\)\"$""\"/Users/matt/ti/workspaces/ESLO_dev/ble5_simple_central_cc2640r2lp_app/.config/xconfig_app_ble/\1\""' package/cfg/app_ble_pem3.xdl > $@
