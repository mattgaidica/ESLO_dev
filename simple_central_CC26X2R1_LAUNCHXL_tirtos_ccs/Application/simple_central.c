...
static uint8_t acGroup[4] = { 0x03,
GAP_ADTYPE_LOCAL_NAME_SHORT, 'G', 'A' };
...
static void ESLO_LogAdvertisement(GapScan_Evt_AdvRpt_t *pAdvRpt);
...
/*********************************************************************
 * !! Matt: needs fixing to handle non-existant SC_ITEM_STRTRSSI
